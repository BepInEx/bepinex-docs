...
* A class that inhertis @BepInEx.BaseUnityPlugin;
...
> [!TIP]
> @BepInEx.BaseUnityPlugin inherits [UnityEngine.MonoBehaviour](https://docs.unity3d.com/ScriptReference/MonoBehaviour.html).  
